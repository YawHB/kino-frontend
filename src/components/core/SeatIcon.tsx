...
export default function SeatIcon({color, text}: Props) {
  return (
      <div className="flex gap-1 items-center">
          <div className="w-6">
              <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 356 289" preserveAspectRatio="xMidYMid meet">
                  <g transform="translate(20.0,270.0) scale(0.50,-0.50)" fill={`${color}`} stroke="none">
                      <path
